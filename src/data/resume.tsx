...
export const DATA = {
  ...
  summary: `I'm a Front-End Developer and Web Designer from Chennai, India, passionate about building sleek, intuitive web experiences using React, Next.js, and TypeScript. With 3+ years of experience, I specialize in crafting responsive designs and modern interfaces that bring ideas to life on the web.`,
  avatarUrl: "/illu.jpeg",
  skills: [
    "React",
    "Next.js",
